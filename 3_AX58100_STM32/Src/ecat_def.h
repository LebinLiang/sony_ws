...
NOTE: The PDI type needs also to be configured in the "ESC_CONFIG_DATA". */
#ifndef MCI_HW
#define MCI_HW                                    1 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#define MAX_PD_INPUT_SIZE                         0x10 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#define MAX_PD_OUTPUT_SIZE                        0x10 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
