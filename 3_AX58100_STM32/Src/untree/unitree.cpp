			...
			if (rp[0] == 0xFE && rp[1] == 0xEE) {
				switch (motor_recv_raw.ServoData.head.motorID)
				{
					...
					case 1:
						...
						a1_joint2_.Update((uint8_t*)&motor_recv_raw.ServoData);
						a1_joint2_.error_p_->data_is_error = 0;//data_is_error = 0;
					break;
					case 2:
						a1_joint3_.motor_recv_.ServoData.CRCdata = motor_recv_raw.ServoData.CRCdata;
			...
			if (rp[0] == 0xFE && rp[1] == 0xEE) {
				switch (motor_recv_raw.ServoData.head.motorID)
				{
					...
					case 1:
						...
						a1_joint5_.Update((uint8_t*)&motor_recv_raw.ServoData);
						a1_joint5_.error_p_->data_is_error = 0;//data_is_error = 0;
					break;
					case 2:
						a1_joint6_.motor_recv_.ServoData.CRCdata = motor_recv_raw.ServoData.CRCdata;
						a1_joint6_.Update((uint8_t*)&motor_recv_raw.ServoData);
